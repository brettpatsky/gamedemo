# Composite Livy's v3 animation frames into 124px horizontal strips for
# resources/livy8/, following docs/pixellab_8dir_character_guide.md (§5a + §6).
...
# Usage: build_livy.ps1 <extracted-char-root> [mirror]
Add-Type -AssemblyName System.Drawing

$envDir = "c:\projects\gamedemo\new-game-project\resources\livy8"
