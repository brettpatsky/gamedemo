# Composite Siena's v3 animation frames into 124px horizontal strips for
# resources/siena8/, following docs/pixellab_8dir_character_guide.md (§5a + §6).
...
$envDir = "c:\projects\gamedemo\new-game-project\resources\siena8"
...
function Map-AnimName($folderName) {
  ...
  if ($folderName -like "holding*")  { return "shoot" }  # bow draw/release
