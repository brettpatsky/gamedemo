# Composite Rindy's v3 animation frames into 124px horizontal strips for
# resources/rindy8/, following docs/pixellab_8dir_character_guide.md (§5a + §6).
...
# Usage: build_rindy.ps1 <extracted-char-root> [mirror]
Add-Type -AssemblyName System.Drawing

$envDir = "c:\projects\gamedemo\new-game-project\resources\rindy8"
...
# or to fill any direction v3 silently dropped (idle/south-west on this build).
...
# v3 dropped idle/south-west on this build -> always mirror it from idle_down_right.
Mirror-Frames "idle_down_right.png" "idle_down_left.png"

# Optional full mirror pass (right -> left) for any animation rendered back-facing.
if ($args[1] -eq "mirror") {
