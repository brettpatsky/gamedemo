...
#
# FortifiedStructure._destroy()    → objective_complete.emit()  (Level 4)
# ExtractionZone._on_npc_arrived() → objective_complete.emit()  (Level 5)
# NPCEscort._die()                 → objective_failed.emit()    (Level 5)
# =============================================================================
extends Node
